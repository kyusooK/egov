<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="UserAddress" v-model="value.userAddress" :editMode="editMode" :inputUI="''"/>
            <Date label="OrderDt" v-model="value.orderDt" :editMode="editMode" :inputUI="''"/>
            <List&lt;OrderDetail&gt; offline label="OrderDetails" v-model="value.orderDetails" :editMode="editMode" @change="change"/>
            <OrderDetailManager offline label="OrderDetails" v-model="value.orderDetails" :editMode="editMode" @change="change"/>
